...
class ITK_EXPORT OpenCLFFTConvolutionImageFilter
    : public itk::OpenCLImageToImageFilter<
          itk::Image<float, 3U>, itk::Image<float, 3U>, TParentImageFilter>
// Well this is just a way of inheritance, not that cuda specific, but
// convenient for GPU stuff.
{
public:
  ...
  typedef itk::Image<std::complex<FFTInputPixelType>, 3U>
      OpenCLFFTOutputImageType;
  typedef
      typename OpenCLFFTOutputImageType::Pointer OpenCLFFTOutputImagePointer;
...
protected:
   ...
   * Med Phys, 2000]. centralRegion is the region of the returned image which
