if(NOT USE_ITK_DCMTK)
  ...
  set(DCMTK_FOUND ON)
  set(PLM_SYSTEM_DCMTK PREFERRED CACHE STRING "" FORCE)
  set(PLM_CONFIG_ENABLE_DCMTK ON CACHE BOOL "" FORCE)
  # However, plm currently uses suberbuild to do so:
  set(PLM_CONFIG_ENABLE_SUPERBUILD OFF CACHE BOOL "" FORCE)
  set(DCMTK_LIBRARIES ${ITKDCMTK_LIBRARIES} CACHE STRING "" FORCE)
  set(DCMTK_INCLUDE_DIRS ${ITKDCMTK_INCLUDE_DIRS} CACHE PATH "" FORCE)
endif()
...
# CUDA
#if(USE_CUDA)
#  set(PLM_CONFIG_ENABLE_CUDA ON CACHE BOOL "" FORCE)
...
#else()
set(PLM_CONFIG_ENABLE_CUDA OFF CACHE BOOL "" FORCE)
#endif()
...
if(NOT USE_SYSTEM_DLIB)
  set(PLM_PREFER_SYSTEM_DLIB ON CACHE PATH "" FORCE)
  set(dlib_DIR ${DLIB_BINARY_DIR} CACHE PATH "" FORCE)
endif()
