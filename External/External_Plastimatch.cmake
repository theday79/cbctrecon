set(PLM_USE_SYSTEM_DCMTK YES CACHE STRING "" FORCE)
message(STATUS "test: ${DCMTK_BINARY_DIR}")
set(DCMTK_DIR "${DCMTK_BINARY_DIR}/../" CACHE PATH "" FORCE)

set(PLM_USE_SYSTEM_ITK YES CACHE STRING "" FORCE)
...
# OpenMP
set(PLM_CONFIG_ENABLE_OPENMP ${OpenMP_FOUND} CACHE BOOL "" FORCE)
set(OPENMP_FLAGS ${OpenMP_CXX_FLAGS} CACHE STRING "" FORCE)
set(OPENMP_LIBRARIES ${OpenMP_CXX_LIB_NAMES} CACHE STRING "" FORCE)
