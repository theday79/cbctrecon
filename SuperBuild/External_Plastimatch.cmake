...
if(NOT DEFINED Plastimatch_DIR AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  ExternalProject_SetIfNotDefined(
    ...
    "b9b6c7f59b98d52a93d58288af9d5bc25d00f24b"
    # "b8587e55ee7d6843a6ab2688432ade35fc7581b6"
    QUIET
    )

  IF (("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang") AND (UNIX AND NOT APPLE))
    message(STATUS "Disabling compiler-specific extensions for plastimatch, i.e. __float128")
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_ARGS
      -DCMAKE_CXX_EXTENSIONS:BOOL=OFF
    )
    list(APPEND ADDITIONAL_CMAKE_CXX_FLAGS
      -D__STRICT_ANSI__
    )
  ENDIF ()
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      -DPLM_BUILD_TESTING:BOOL=${BUILD_TESTING}
      ...
      -DPLM_CONFIG_ENABLE_OPENMP:BOOL=${OpenMP_FOUND}
      -DOPENMP_FLAGS:STRING=${OpenMP_CXX_FLAGS}
      -DOPENMP_LIBRARIES:STRING=${OpenMP_CXX_LIB_NAMES}
      ...
      -DPLM_CONFIG_LEGACY_CUDA_DELAYLOAD:BOOL=OFF
