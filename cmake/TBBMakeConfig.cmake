...
#
# Usage: include(TBBMakeConfig.cmake) tbb_make_config(TBB_ROOT <tbb_root> SYSTEM_NAME
# <system_name> CONFIG_DIR <var_to_store_config_dir> [SAVE_TO] [CONFIG_FOR_SOURCE
# TBB_RELEASE_DIR <tbb_release_dir> TBB_DEBUG_DIR <tbb_debug_dir>])
#

include(CMakeParseArguments)

# Save the location of Intel TBB CMake modules here, as it will not be possible to do
# inside functions, see for details:
...
if (WINDOWS_STORE)
    ...
    # Note: multiline variable tbb/internal/_tbb_windef.h (included via tbb/tbb_stddef.h)
    # does implicit linkage of some .lib files, use a special define to avoid it
...
unset(_tbb_compiler_subdir)")
  ...
  configure_file(${_tbb_cmake_module_path}/templates/TBBConfigInternal.cmake.in
                 ${tbb_config_dir}/TBBConfig.cmake @ONLY)
  configure_file(${_tbb_cmake_module_path}/templates/TBBConfigVersion.cmake.in
                 ${tbb_config_dir}/TBBConfigVersion.cmake @ONLY)

  set(${tbb_MK_CONFIG_DIR}
      ${tbb_config_dir}
      PARENT_SCOPE)
endfunction()
