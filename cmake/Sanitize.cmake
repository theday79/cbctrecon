function(sanitize_clang theTarget)
  target_compile_options(
    ${theTarget}
    PUBLIC $<$<CONFIG:Debug>:-fsanitize=undefined>
           $<$<CONFIG:Debug>:-fsanitize=integer>
           $<$<CONFIG:Debug>:-fsanitize=address>
           $<$<CONFIG:Debug>:-fno-omit-frame-pointer>)
  target_link_libraries(${theTarget} PUBLIC $<$<CONFIG:Debug>:-fsanitize=address>)
endfunction()

function(sanitize_appleclang theTarget)
  target_compile_options(${theTarget} PUBLIC $<$<CONFIG:Debug>:-fsanitize=address>
                                             $<$<CONFIG:Debug>:-fno-omit-frame-pointer>)
  target_link_libraries(${theTarget} PUBLIC $<$<CONFIG:Debug>:-fsanitize=address>)
endfunction()
...
function(sanitize_gcc theTarget)
  if(NOT SCORE_COTIRE) # Sanitizer won't work with PCHs
    ...
    target_link_libraries(
      ${theTarget}
      PUBLIC $<$<CONFIG:Debug>:-fsanitize=address>
             $<$<CONFIG:Debug>:-fsanitize=undefined> $<$<CONFIG:Debug>:-fuse-ld=gold>)
  endif()
endfunction()
