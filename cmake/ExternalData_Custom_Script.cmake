...
while(retry)
  ...
  elseif(NOT "${ExternalData_TIMEOUT_ABSOLUTE}" EQUAL 0)
    set(absolute_timeout TIMEOUT 600)
  else()
    set(absolute_timeout "")
  endif()
  file(DOWNLOAD "${ExternalData_CUSTOM_LOCATION}" "${ExternalData_CUSTOM_FILE}" STATUS status LOG log ${inactivity_timeout} ${absolute_timeout})
