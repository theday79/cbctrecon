#
# service functions: set_target_cpu_flags set_target_vectorizer_report_flags
# print_target_compiler_options

cmake_policy(SET CMP0054 NEW)
# set processor speicif compilation options, based either on externally defined
# ENABLE_SSE42/ENABLE_AVX2 options or based on detected host processor featured
# (HAVE_SSE/HAVE_AVX2) Note, when ENABLE_AVX2 option is on by any means then ENABLE_SSE42
# option will be turned on if not set explicitely

function(set_target_cpu_flags TARGET_NAME)
  # if have cpuid info and not requested specific cpu features externally turn on cpu
  # specific compile options based on detected features of host processor if don't have
  # cpuid info or cpu specific features explicitly requested set compile options based on
  # requested features
  if(${HAVE_CPUID_INFO})
    # ENABLE_SSE42, ENABLE_AVX2, ENABLE_AVX512 weren't set explicitly, so derive it from
    # host cpu features
    if((NOT DEFINED ENABLE_SSE42)
       AND (NOT DEFINED ENABLE_AVX2)
       AND (NOT DEFINED ENABLE_AVX512F))
    ...
    # Consider as request to build for Xeon (Skylake server and later), turn on SSE42 and
    # AVX2 as supported feature
    if((NOT DEFINED ENABLE_SSE42)
       AND (NOT DEFINED ENABLE_AVX2)
       AND (${ENABLE_AVX512F}))
      set(ENABLE_SSE42 ON)
...
# function set vectorization report flags in case of Intel compiler (might be useful for
# analisys of which loops were not vectorized and why)
